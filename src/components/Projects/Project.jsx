...
const Projects = () => {
  return (
    <div id="Projects" className="py-12 px-8 flex text-white flex-wrap gap-5 justify-center">
      <h1 className="text-2xl md:text-4xl font-bold text-white w-full text-center mb-6">Projects</h1>
